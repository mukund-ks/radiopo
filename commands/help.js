    ...
    async execute(interaction) {
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: 'Directory of Station Names:', value: '[Here](https://www.radio-browser.info/countries)' },
                ...
                { name: 'Visit the website.', value: 'https://radiopo.xyz', inline: true },
                { name: 'Report Issues.', value: '[Here](https://github.com/mukund-ks/radiopo/issues)', inline: true },
            )
